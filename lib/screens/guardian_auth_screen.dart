...
class _GuardianAuthScreenState extends State<GuardianAuthScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(_isLogin ? 'Guardian Login' : 'Guardian Sign Up'),
      ),
      body: Padding(
              ...
              ElevatedButton(
                onPressed: () {
                  if (_formKey.currentState!.validate()) {
                    ...
                    // Add logic to authenticate the guardian
                    // You can access the form values using the controllers
                    // e.g., _emailController.text
                    // After successful authentication, navigate to the Guardian Dashboard
